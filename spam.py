...
viptime = 100
ALLOWED_GROUP_ID = -1002617239722   # ID BOX
admin_diggory = "Siunhan407" # ví dụ : để user name admin là @diggory347 bỏ dấu @ đi là đc
name_bot = "Spam Sms Hehe"
zalo = "0827546770"
facebook = "no"
...
BOT_LINK = ''
TOKEN = '7491923931:AAELj7xGmahcpd1HkXxu_lq6y30GZBwDEdQ'  
bot = TeleBot(TOKEN)
...
def laykey(message):
    ...
    url_key = requests.get(f'https://yeumoney.com/QL_api.php?token=8156cc19fdccefe54eb38837dd06e2b771d2158187c2971a7c7ad7a4735acb96&format=json&url=https://jirayshop.xyz/key.php?r={key}').json()['shortenedUrl']
